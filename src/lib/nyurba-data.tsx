...
export const ROUTES = [
  ...
  },
  {
    ...
    typeLabel: "Культурный",
    distance: "60 км",
    desc: "Историко-культурный маршрут по местам жизни купца и мецената Степана Алексеева-Боһуута: Бестяхский наслег, Чаппангдинская церковь и усадьба.",
    img: "https://cdn.poehali.dev/projects/43add130-f0a3-4685-b545-30941f096855/bucket/2a9b00af-32cc-4b8f-9c41-f0005410b268.jpg",
    detailUrl: "/route-bohuut",
  },
  {
    id: 6,
    name: "Зимний Вилюй",
